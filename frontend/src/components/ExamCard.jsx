...
const ExamCard = ({ document }) => {
  ...
  return (
    <>
      <div className='card font-sans rounded-md border border-white'>
        ...
        <Link className="py-2.5" to={`/document/${document._id}`}>
          <p
            className='product-title font-normal px-1'
             ...
             size={27}
              className='cursor-pointer text-primary-green' />
               :
                <BsFillHeartFill 
                onClick={submitHandler}
                 size={27}className='text-primary-green' /> }
          
          <span
            className='text-primary-green cursor-pointer mx-1 color-primary-green'
          >
            {document.numReviews}
          </span>
